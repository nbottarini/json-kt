...
class JsonLiteralTest {
    ...
    inner class `null` {
        ...
        fun equals() {
            ...
            assertThat(JsonLiteral.NULL).isEqualTo(Json.value(null))
            ...
            assertThat(JsonLiteral.NULL).isNotEqualTo(Json.value("null"))
        }
    ...
    inner class `true` {
        ...
        fun equals() {
            ...
            assertThat(JsonLiteral.TRUE).isNotEqualTo(Json.value("true"))
        }
    ...
    inner class `false` {
        ...
        fun equals() {
            ...
            assertThat(JsonLiteral.FALSE).isNotEqualTo(Json.value("false"))
        }
