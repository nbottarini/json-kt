...
class JsonObjectTest {
    ...
    fun `create with list of pairs`() {
        ...
        assertThat(obj["name"]).isEqualTo(Json.value("John"))
        assertThat(obj["age"]).isEqualTo(Json.value(54))
    }
    ...
    inner class iterator {
        ...
        fun `iterator next returns actual value`() {
            ...
            assertThat(item.value).isEqualTo(Json.value(1))
        }
        ...
        fun `iterator next progresses to next value`() {
            ...
            assertThat(item.value).isEqualTo(Json.value(2))
        }
    ...
    fun `get returns value for key`() {
        ...
        assertThat(obj["foo"]).isEqualTo(Json.value("bar"))
    }
    ...
    inner class with {
        ...
        @Test
        fun `with json null`() {
            obj.with("a", Json.NULL)
            assertThat(obj).isEqualTo(JsonObject("a" to Json.NULL))
        }
    ...
    inner class set {
        ...
        @Test
        fun put() {
            obj.put("a", Json.value("foo"))
            assertThat(obj).isEqualTo(JsonObject("a" to "foo"))
        }

        @Test
        fun `put changes element`() {
            obj.put("a", Json.value("23"))
            obj.put("a", Json.value("foo"))
            assertThat(obj).isEqualTo(JsonObject("a" to "foo"))
        }
    ...
    fun containsValue() {
        ...
        assertThat(obj.containsValue(Json.value(2))).isTrue
        assertThat(obj.containsValue(Json.value(4))).isFalse
    }
    ...
    fun entries() {
        ...
        assertThat(obj.entries.any { it.key == "a" && it.value == Json.value(1) }).isTrue
        assertThat(obj.entries.any { it.key == "b" && it.value == Json.value(2) }).isTrue
        assertThat(obj.entries.any { it.key == "c" && it.value == Json.value(3) }).isTrue
    }
    ...
    fun values() {
        ...
        assertThat(obj.values).containsExactlyInAnyOrder(Json.value(1), Json.value(2), Json.value(3))
    }
    ...
    fun `path simple object`() {
        ...
        assertThat(json.path("name")).isEqualTo(Json.value("John"))
        assertThat(json.path(".name")).isEqualTo(Json.value("John"))
    }
    ...
    fun `path nested objects`() {
        ...
        assertThat(json.path("user.address.street")).isEqualTo(Json.value("Avellaneda"))
        assertThat(json.path(".user.address.street")).isEqualTo(Json.value("Avellaneda"))
    }
    ...
    fun `path nested array and objects`() {
        ...
        assertThat(json.path("user.addresses[1].street")).isEqualTo(Json.value("Cabildo"))
        assertThat(json.path(".user.addresses[1].street")).isEqualTo(Json.value("Cabildo"))
    }
