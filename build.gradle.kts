...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            connection.set("scm:git:git://github.com/nbottarini/json-kt.git")
            developerConnection.set("scm:git:ssh://github.com/nbottarini/json-kt.git")
            url.set("https://github.com/nbottarini/json-kt")
        }
    }
}
